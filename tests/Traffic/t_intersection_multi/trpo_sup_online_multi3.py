...
def experiment(variant):
    ...
    from rlkit.torch.vpg.trpo_sup_online import TRPOSupOnlineTrainer
    trainer = TRPOSupOnlineTrainer(
        policy=policy,
        value_function=vf,
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='TRPOSupOnline3')
