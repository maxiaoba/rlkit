...
def experiment(variant):
    ...
    label_num = eval_env.label_num
    label_dim = eval_env.label_dim
    ...
    policy = SoftmaxLSTMPolicy(
                ...
                h_0=h_0,
                c_0=c_0,
                obs_dim=obs_dim+int(label_num*label_dim),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default='PPOSupSep2LSTM')
