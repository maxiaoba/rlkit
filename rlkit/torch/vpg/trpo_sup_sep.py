...
class TRPOSupSepTrainer(TRPOTrainer):
    """TRPO + supervised learning.
        use true label as input for policy
    """
    ...
    def _train_policy(self, obs, actions, rewards, advantages, labels):
        ...
        self._policy_optimizer.step(
            f_loss=lambda: self._compute_loss_with_adv(obs, actions, rewards, advantages, labels),
            f_constraint=lambda: self._compute_kl_constraint(obs, labels))
        return loss
